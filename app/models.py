...
class User(Base):
    ...
    phone_verified: Mapped[bool] = mapped_column(Boolean, default=False, server_default="0", nullable=False)
    onboarding_status: Mapped[str] = mapped_column(String(64), nullable=False, default="new", server_default="new")
